 ...
 * desc 可以自己相同的方式实现
 */
public abstract class BaseMvpActivity<T extends BaseTemplateUI, P extends IBasePresenter> extends com.hy.frame.base.BaseXActivity<T> implements IBaseView, IBasePresenterView<P> {
